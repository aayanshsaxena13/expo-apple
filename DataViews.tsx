      ...
      {data?.map((item: any, index) => (
        <View key={index}
          style={{
            ...
            borderBottomWidth: index != data.length - 1 ? dim.width < 420 ? 1.6 : 3.2 : 0,
        ...
        {keys?.map((item: any, index) => (
          <View key={index}
            style={{
              ...
              borderBottomWidth: index != keys.length - 1 ? dim.width < 420 ? 1.6 : 3.2 : 0,
              borderRightWidth: dim.width < 420 ? 1.6 : 3.2,
              borderColor: "rgb(134, 134, 134)",
              width: dim.width < 420 ? 100 : 120,
              padding: dim.width < 420 ? 12 : 16,
            }}
          >
        ...
        {values?.map((item: any, index) => (
          <View key={index}
            style={{
              ...
              borderBottomWidth: index != values.length - 1 ? dim.width < 420 ? 1.6 : 3.2 : 0,
              borderColor: "rgb(134, 134, 134)",
            }}
          >
            <View style={{
              ...
              {item?.map((subItem: any, subIndex: number) => (
                <View key={subIndex} style={{
                  borderRightWidth: subIndex !== item.length - 1 ? dim.width < 420 ? 1.6 : 3.2 : 0,
